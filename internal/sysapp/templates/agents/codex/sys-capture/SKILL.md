...
3. Run or read `sys capture` for current capture guidance.
...
- Build phase blocks normal capture. If status shows build phase, stop and use `sys design-change`.
...
- Do Not bypass `sys design-change` in build phase.
