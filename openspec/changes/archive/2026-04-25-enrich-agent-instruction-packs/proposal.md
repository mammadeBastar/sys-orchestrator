...
- Keep `sys agent install codex` as the one-command install path, but make the generated skills detailed enough to guide real agent work.
...
- Does not change the command surface: `sys agent install codex|cursor|claude` remains the user API.
