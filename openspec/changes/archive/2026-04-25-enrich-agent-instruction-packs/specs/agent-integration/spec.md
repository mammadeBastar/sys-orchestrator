...
- **THEN** it requires build phase, OpenSpec apply usage, Superpowers apply discipline, `/system` context review, frozen-file protection, design drift detection, and escalation to `sys-design-change` when foundational truth must change
